...
let userNameOrPasswordIncorrect = new Error("Username or password is incorrect");
userNameOrPasswordIncorrect.status = 403;

let votingNotAllowed = new Error("Cannot vote more than one time");
votingNotAllowed.status = 403;

let dateNotValid = new Error("The given date not valid");
dateNotValid.status = 403;
...
module.exports = {
  ...
  votingNotAllowed: votingNotAllowed,
